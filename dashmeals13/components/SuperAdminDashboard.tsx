...
import { 
  ...
  UserPlus, UserMinus, ShieldCheck, ShieldAlert, RefreshCw, Bike
} from 'lucide-react';
          ...
          <div className="flex items-center space-x-3">
            <div className="text-right">
              ...
              <div className="flex items-center justify-end mt-1">
                <span className="flex items-center text-[8px] font-black text-emerald-500 uppercase tracking-widest leading-none">
