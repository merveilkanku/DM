...
export const CustomerView: React.FC<Props> = ({ user, allRestaurants, onLogout, theme, setTheme, language, setLanguage, font, setFont, onUpdateUser }) => {
            ...
            <div className="bg-white dark:bg-gray-800 rounded-[40px] shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div className="bg-brand-600 p-10 text-white text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <h2 className="text-3xl font-display font-black uppercase italic tracking-tight mb-2">Devenir Livreur</h2>
                ...
                <div className="p-8 sm:p-12">
                    {onboardingStep === 1 && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="text-center">
                                <h3 className="font-display font-black text-gray-900 dark:text-white text-2xl uppercase italic tracking-tight mb-2">Quel est votre véhicule ?</h3>
                            ...
                            <div className="flex justify-center pt-4">
                                <button 
                                    ...
                                    className="w-full sm:w-auto px-16 py-5 bg-brand-600 text-white rounded-[32px] font-black text-sm uppercase italic tracking-widest shadow-xl shadow-brand-500/20 hover:bg-brand-700 transition-all flex items-center justify-center gap-2 active:scale-95"
                                >
                    ...
                    {onboardingStep === 2 && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="text-center">
                                <h3 className="font-display font-black text-gray-900 dark:text-white text-2xl uppercase italic tracking-tight mb-2">Pièce d'Identité</h3>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                                ...
                                <button 
                                    ...
                                    className="flex-1 sm:flex-none px-16 py-5 bg-brand-600 text-white rounded-[32px] font-black text-sm uppercase italic tracking-widest shadow-xl shadow-brand-500/20 hover:bg-brand-700 transition-all flex items-center justify-center gap-2 active:scale-95"
                                >
                                    Continuer <ArrowRight size={20} />
                                </button>
                            </div>
                    ...
                    {onboardingStep === 3 && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="text-center">
                                <h3 className="font-display font-black text-gray-900 dark:text-white text-2xl uppercase italic tracking-tight mb-2">Documents Photos</h3>
                                ...
                                >
                                    {idCardFile ? (
                                        <>
                                            ...
                                            <p className="text-[10px] text-brand-500 font-bold truncate max-w-full px-4 mt-1 italic">{idCardFile.name}</p>
                                        </>
                                    ) : (
                                        <>
                                    ...
                                    >
                                        {licenseFile ? (
                                            <>
                                                ...
                                                <p className="text-[10px] text-brand-500 font-bold truncate max-w-full px-4 mt-1 italic">{licenseFile.name}</p>
                                            </>
                                        ) : (
                                            <>
                                                <div className="w-16 h-16 bg-gray-100 dark:bg-gray-800 text-gray-400 group-hover:text-brand-600 group-hover:bg-brand-50 transition-colors rounded-2xl flex items-center justify-center mb-4">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                                ...
                                <button 
                                    ...
                                    className="flex-1 sm:flex-none px-16 py-5 bg-brand-600 text-white rounded-[32px] font-black text-sm uppercase italic tracking-widest shadow-xl shadow-brand-500/20 hover:bg-brand-700 transition-all flex items-center justify-center gap-3 active:scale-95 disabled:opacity-50 disabled:grayscale"
                                >
                    ...
                    {onboardingStep === 4 && (
                        <div className="text-center py-12 space-y-8 animate-in zoom-in duration-700">
                            ...
                            <div className="max-w-xs mx-auto">
                                <h3 className="font-display font-black text-gray-900 dark:text-white text-2xl mb-3 uppercase italic tracking-tight">Demande Reçue !</h3>
                            ...
                            <div className="flex justify-center pt-4">
                                <button 
                                    ...
                                    className="px-12 py-5 bg-brand-600 text-white rounded-[32px] font-black text-sm uppercase italic tracking-widest shadow-xl shadow-brand-500/20 hover:bg-brand-700 transition-all active:scale-95 flex items-center gap-2"
                                >
  ...
  return (
    <div className="min-h-screen pb-20 max-w-md md:max-w-none mx-auto bg-gray-50 dark:bg-gray-900 shadow-2xl md:shadow-none relative transition-colors duration-300">
      ...
      {/* HEADER */}
      <header className="sticky top-0 z-50 glass shadow-sm border-b border-gray-100 dark:border-white/5">
            ...
            />
             ...
             <div className="animate-in fade-in slide-in-from-right duration-500 max-w-2xl mx-auto px-4 sm:px-0">
                ...
                <div className="flex flex-col items-center text-center mb-10">
                    ...
                    <h2 className="text-3xl font-display font-black text-gray-900 dark:text-white uppercase italic tracking-tight">{t('settings')}</h2>
                ...
                <div className="space-y-8 pb-32">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-[32px] shadow-sm border border-gray-100 dark:border-gray-700">
                        <h3 className="font-display font-black text-gray-900 dark:text-white mb-6 flex items-center uppercase italic tracking-tight">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <p className="text-sm font-black text-gray-900 dark:text-white uppercase italic tracking-tight">{t('help_center')}</p>
                            ...
                            >
                                ...
                                <p className="text-sm font-black text-gray-900 dark:text-white uppercase italic tracking-tight">{t('contact_support')}</p>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-[32px] shadow-sm border border-gray-100 dark:border-gray-700">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button 
                                ...
                                className={`flex flex-col items-center py-6 px-4 rounded-[24px] font-black text-xs uppercase italic tracking-widest border-2 transition-all active:scale-95 ${theme === 'light' ? 'bg-orange-50 border-orange-500 text-orange-700 shadow-lg shadow-orange-500/20' : 'bg-gray-50 dark:bg-gray-700 border-gray-100 dark:border-gray-600 text-gray-400'}`}
                            >
                            ...
                            <button 
                                ...
                                className={`flex flex-col items-center py-6 px-4 rounded-[24px] font-black text-xs uppercase italic tracking-widest border-2 transition-all active:scale-95 ${theme === 'dark' ? 'bg-blue-900/20 border-blue-500 text-blue-400 shadow-lg shadow-blue-500/20' : 'bg-gray-50 dark:bg-gray-700 border-gray-100 dark:border-gray-600 text-gray-400'}`}
                            >
                    ...
                    {user.role === 'client' && (
                        <div className="bg-gradient-to-br from-brand-600 to-orange-500 p-8 rounded-[40px] shadow-2xl shadow-brand-500/20 text-white relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-3xl font-display font-black uppercase italic tracking-tight mb-2 leading-none">
                                    {t('earn_with_us')}
                                </h3>
                                ...
                                <div className="flex justify-center">
                                    <button 
                                        ...
                                        className="w-full sm:w-auto px-12 py-5 bg-white text-brand-600 rounded-[32px] font-black text-sm uppercase italic tracking-widest hover:bg-brand-50 transition-all shadow-xl active:scale-95 flex items-center justify-center gap-2"
                                    >
                        ...
                        <div className="bg-white dark:bg-gray-800 p-6 rounded-[32px] shadow-sm border border-gray-100 dark:border-gray-700">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="p-6 bg-gray-50 dark:bg-gray-700/50 rounded-3xl flex flex-col items-center text-center">
                                    ...
                                    <p className="text-sm font-black text-gray-900 dark:text-white uppercase italic tracking-tight mb-1">{t('app_lock')}</p>
                                ...
                                <div className="p-6 bg-gray-50 dark:bg-gray-700/50 rounded-3xl flex flex-col items-center text-center">
                                    <div className="p-3 bg-white dark:bg-gray-800 rounded-2xl mb-4 shadow-sm">
                                        <Fingerprint size={24} className="text-gray-600 dark:text-gray-300" />
                                    </div>
                                    <p className="text-sm font-black text-gray-900 dark:text-white uppercase italic tracking-tight mb-1">{t('biometrics')}</p>
                                    <p className="text-[10px] text-gray-500 font-bold uppercase mb-4">{t('use_phone_sensors')}</p>
                                    <button 
                                        onClick={() => updateSecuritySettings({ biometricsEnabled: !user.settings?.biometricsEnabled })}
                                        className={`w-14 h-7 rounded-full transition-all relative ${user.settings?.biometricsEnabled ? 'bg-brand-600 ring-4 ring-brand-100 dark:ring-brand-900/20' : 'bg-gray-300 dark:bg-gray-600'}`}
                                    >
                                        <div className={`absolute top-1 w-5 h-5 rounded-full bg-white shadow-xl transition-all ${user.settings?.biometricsEnabled ? 'right-1' : 'left-1'}`}></div>
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-red-50/50 dark:bg-red-900/10 p-6 rounded-[32px] border border-red-100 dark:border-red-900/30 flex flex-col items-center text-center">
                        ...
                        <h3 className="text-xl font-display font-black text-red-600 uppercase italic tracking-tight mb-2">Déconnexion</h3>
                        ...
                        <div className="flex justify-center w-full">
                            <button 
                                onClick={onLogout} 
                                className="w-full sm:w-auto px-16 py-4 bg-red-600 text-white rounded-[24px] font-black text-sm uppercase italic tracking-widest hover:bg-red-700 transition-all shadow-xl shadow-red-500/20 active:scale-95" 
      ...
      {/* BOTTOM NAV */}
      <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-6 py-3 flex justify-around items-center z-40 max-w-md md:max-w-7xl mx-auto transition-colors duration-300 rounded-t-[32px] md:rounded-none shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
